<template>
    <v-container fluid>
      ...
      <v-row justify="center">
        <v-col cols="auto">
          <vue-pdf-embed ref="pdf_embed" class="pdf" :source="pdfSource" @click="openPDF()"/>
        </v-col>
      </v-row>
    </v-container>
</template>
